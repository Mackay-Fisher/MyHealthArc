...
final class NutritionEntryTest: XCTestCase {
    ...
    func testInsertNutrition1() async throws {
        try await insertNutrition(userHash: "user1", proteinMinimum: 10.0, proteinMaximum: 20.0, carbohydratesMinimum: 10.0, carbohydratesMaximum: 20.0, fatsMinimum: 10.0, fatsMaximum: 20.0, caloriesMinimum: 10, caloriesMaximum: 20)
    }

    func testInsertNutrition2() async throws {
        try await insertNutrition(userHash: "user2", proteinMinimum: 15.0, proteinMaximum: 25.0, carbohydratesMinimum: 15.0, carbohydratesMaximum: 25.0, fatsMinimum: 15.0, fatsMaximum: 25.0, caloriesMinimum: 150, caloriesMaximum: 250)
    }

    func testInsertNutrition3() async throws {
        try await insertNutrition(userHash: "user3", proteinMinimum: 20.0, proteinMaximum: 30.0, carbohydratesMinimum: 20.0, carbohydratesMaximum: 30.0, fatsMinimum: 20.0, fatsMaximum: 30.0, caloriesMinimum: 200, caloriesMaximum: 300)
    }

    func testInsertNutrition4() async throws {
        try await insertNutrition(userHash: "user4", proteinMinimum: 25.0, proteinMaximum: 35.0, carbohydratesMinimum: 25.0, carbohydratesMaximum: 35.0, fatsMinimum: 25.0, fatsMaximum: 35.0, caloriesMinimum: 250, caloriesMaximum: 350)
    }

    func testInsertNutrition5() async throws {
        try await insertNutrition(userHash: "user5", proteinMinimum: 50.0, proteinMaximum: 50.0, carbohydratesMinimum: 50.0, carbohydratesMaximum: 50.0, fatsMinimum: 50.0, fatsMaximum: 50.0, caloriesMinimum: 500, caloriesMaximum: 550)
    }

    private func insertNutrition(userHash: String, proteinMinimum: Double, proteinMaximum: Double, carbohydratesMinimum: Double, carbohydratesMaximum: Double, fatsMinimum: Double, fatsMaximum: Double, caloriesMinimum: Int, caloriesMaximum: Int) async throws {
